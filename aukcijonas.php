...
Į turgų galėsite patekti tik nuo 130 lygio!</b><br/>
...
echo"<b>Turgus</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: left;\">";
echo "<a href=\"litu_turgus.php\">Litų turgus</a><br/></div><div class=\"meniu\" style=\"text-align: left;\">
<a href=\"aukcijonas.php?id=idet\">Įdėti preke</a><br/></div><div class=\"meniu\" style=\"text-align: left;\">
<a href=\"aukcijonas.php?id=tau\">Prekes skirtos tau</a><br/></div><div class=\"meniu\" style=\"text-align: left;\">
<a href=\"aukcijonas.php?id=tava\">Mano prekes</a><br/></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: left;\">";

      $nuskk = glob("aukcj/*.txt"); 
      $viso_tm = count($nuskk);
      $puslapiu_skaicius = 20;
	  if (glob("aukcj/*.txt") == false)
{
echo"Prekiu nera";
}
else
{
foreach (@glob("aukcj/*.txt") as $a){

$name = str_replace(array("aukcj/", ".txt"), "", $a);
$ex = count(file($a));
$arr[] = array("$ex", "$name");}
    $sk = count($arr);
...
echo"(&#187;) <a href=\"aukcijonas.php?id=preke&amp;ka=$pavd\">$e[0]  ( $e[1] $e[2] už $e[7]$ $e[8])</a>";
if ($vrd == "@$nick"){echo "<a href=\"aukcijonas.php?id=naikinti&amp;ka=$pavd\"><b>[x]</b></a>"; }
echo"<br/>";}
...
{ 
echo"<a href=\"aukcijonas.php?id=&amp;page=$starto_skaicius\">[$starto_skaicius]</a>"; }
...
{ echo"<b>Turgus</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">";
echo"
<a href=\"aukcijonas.php?id=idet\">Įdeti prekiu</a><br/></div><div class=\"meniu\" style=\"text-align: center;\">
<a href=\"aukcijonas.php?id=\">Visų žaidėjų prekes</a><br/></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: left;\">"; 
...
$pavd = str_replace(array("aukcj/",".txt"),"",$nuskk[$c]); 
echo"(&#187;) <a href=\"aukcijonas.php?id=preke&amp;ka=$ka\">$e[0]  ( $e[1] $e[2] už $e[7]$  $e[8])</a>
<a href=\"aukcijonas.php?id=grazinti&amp;ka=$pavd\">[x]</a>"; }
}
else
{
echo "Prekiu nera<br/>";
...
if ($id == "tau")
{ echo"<b>Prekes skirtos tau</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: left;\">";
echo""; 
...
if ($id == "naikinti" && file_exists("aukcj/$ka.txt")){ 
...
$e[7] = @number_format($e[7], 0, ',', ' ');
echo"<b>Turgus</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
Ar tikrai norite pirkti <b>$e[1] $e[2]</b> už <b>$e[7]$</b> iš <b>$e[0]</b> žaidėjo?
</div><div class=\"meniu\" style=\"text-align: left;\">
<a href=\"aukcijonas.php?id=perku&amp;ka=$ka\">Taip, Perku</a><br/>

</div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"aukcijonas.php?id=\">Atgal</a><br/>
<a href=\"pagrindinis.php?\">&#302; &#381;aidim&#261;</a></br>
</div><div class=\"foot\">$bottom</div></div>";}
...
$privatuj = "Tavo preke ($e[1] $e[2]) turguje nupirko $nick, gavai $e[7] pinigų"; 
...
if ($id == "grazinti" && file_exists("aukcj/$ka.txt")){ 
$kj=@ereg_replace("[^0-9.]","",$kj); 
$e = explode("|",file_get_contents("aukcj/$ka.txt")); 
$e2 = file_get_contents("aukcj/$ka.txt"); 
...
if ($id == "idet"){ 
echo"
<b>Turgus</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\"><form action=\"aukcijonas.php?id=dedu\" method=\"post\">
...
if ($dari[45] > 0){ echo"<option value=\"k45\">Kinto debesis [$dari[45]]</option>"; }
if ($dari[46] > 0){ echo"<option value=\"k46\">Potaro auskarai [$dari[46]]</option>"; }
if ($dari[47] > 0){ echo"<option value=\"k47\">Jėgos matuoklis [$dari[47]]</option>"; }
if ($dari[48] > 0){ echo"<option value=\"k48\">Samungo drakono rutuliai [$dari[48]]</option>"; }
echo"</select>
...
Kam skirta preke (jei norite parduoti viešai, visiems, tai palikite šį laukeli tuščia, jei norite, kad preke galetu pirkti tik vienas, konkretus asmuo, tai įveskite jo nick):
<br/>
<input name=\"kam\" type=\"text\" maxlength=\"50\" title=\"info\" value=\"\" size=\"15\"/><br/>
...
if ($kan=="k45"){ $dkfl = "ok"; $pavd="Kinto debesis"; }
if ($kan=="k46"){ $dkfl = "ok"; $pavd="Potaro auskarai"; }
if ($kan=="k47"){ $dkfl = "ok"; $pavd="Jėgos matuoklis"; }
if ($kan=="k48"){ $dkfl = "ok"; $pavd="Samungo drakono rutuliai"; }
include("icludekitainf/nuskait.php"); 
$hex=explode(".",$kj);
...
if (count(glob("aukcj/$nick-*.txt"))>2){ 
...
$tim = time(); 
$fop = fopen("aukcj/$nick-$kodas-$kam.txt", "w+");
        fwrite($fop, "$nick|$da|$pavd|$c|$m|$laikas|$tim|$kj|$kam|\n");
        fclose($fop);
        chmod("aukcj/$nick-$kodas-$kam.txt",0777); 
...
<a href=\"aukcijonas.php?id=\">Į Turgų</a><br/>
