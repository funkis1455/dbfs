...
$nick = $_GET['nick'];
$passs = $_GET['passs'];
$online = count(glob("online/*.txt"))+count(glob("s2/online/*.txt"));
$aktyviu = count(glob("aktyviu/*.txt"))+count(glob("http://s2.dbf.us.lt/aktyviu/*.txt"));
$zaideju = count(glob("zaideju pagrindinai statusai/*.txt"))+count(glob("http://s2.dbf.us.lt/zaideju pagrindinai statusai/*.txt"));
...
<div class="quest">
<i><span class="zalia"><b><small>Šiandien 16:00 bus atidarytas 2 serveris, kuriame bus padusimai 2 sėk. treniruotės 2x pigesnios, drakono rutulių radimas 2x didesnis, sąskaitos pildymas bus brangus, serveris bus ypatingas tuom kad nieko nelems žaidėjai kurie pirks sąskaitos balansą.</small></b></i></span></div>
...
echo "<option value=\"server2\">2 Serveris</option>";
...
$nnn = file("files for txt/add_bottom.txt");
	...
	<a href=\"http://wtop.us/i.php?id=wedb\"><img src=\"http://wtop.us/count.php?id=wedb\" alt=\"WAP TOP\"/></a><br/>
...
echo "<option value=\"server2\">2 Serveris</option>";
echo"<br/></select>";
if ($server == "server1"){$link = 'http://dbf.us.lt';}
if ($server == "server2"){$link = 'http://s2.dbf.us.lt';}

echo"<form action='$link/index.php?id=login' method='post'>
...
<img src=\"logo.png\" alt=\"*\"/>
  ...
  if(empty($nick)){
            echo "Neįvestas žaidėjo vardas! <br/><a href=\"index.php?id=pass2&amp;nick=$nick\"><b>Pamiršote slaptažodį?</b></a><br/>";
			echo"</div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"index.php?&amp;id=\">Į Pagrindinį</a>
</div><div class=\"foot\">$bottom</div></div>";
        }
		...
		if(empty($pass)){
            echo "Neįvestas slaptažodis!<br/><a href=\"index.php?id=pass2&amp;nick=$nick\"><b>Pamiršote slaptažodį?</b></a><br/>";
						echo"</div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"index.php?&amp;id=\">Į Pagrindinį</a>
</div><div class=\"foot\">$bottom</div></div>";
        }
...
if ($pass != $info[1])
{
echo "Blogai &#303;vestas prisijungimo vardas arba slapta&#382;odis<br/><a href=\"index.php?id=pass2&amp;nick=$nick\"><b>Pamiršote slaptažodį?</b></a><br/>";
			echo"</div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"index.php?&amp;id=\">Į Pagrindinį</a>
</div><div class=\"foot\">$bottom</div></div>";
}
...
<a href=\"index.php?&amp;id=\">Į Pagrindinį</a>
            ...
            echo 'Sveikas, <b>'.$nick.'</b> prisijungus prie žaidimo!<br />Gerai praleikite laiką!</b>';
				 ...
				 setcookie('nick2', $nick, time()+60*60*12); // Cookie visi metus :)
			setcookie('pass2', $pass, time()+60*60*12); // Cookie visi metus :)
...
<b>Pamiršote arba kitu būdu netekote savo slaptažodžio?</b></div><div class=\"meniu\" style=\"text-align: center;\">
Jūs galite susigrąžinti savo nick jeigu meniu skyrelyje nustatėte savo telefono numerį.<br/>
Tada jums tereikia išsiųsti žinutę su tekstu:<br/><b>PAS2 $nick</b><br/>
Numeriu:<br/><b>1398</b><br/>
Kaina:<br/><b>1 LT</b><br/>
Šią žinutę privalote siųsti iš to numerio kurį įvedėte būdami prisijungę, jei siuntėjo numeris nesutaps su nustatytuoju, tai jūs slaptažodžio negausite.<br/>
	</DIV><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
...
<a href=\"index.php?id=registers&amp;server=server1\"><img src=\"http://dbf.us.lt/imgs/server1.php\" alt=\"1 serveris\"/></a><br/>
</div><div class=\"meniu\" style=\"text-align: center;\">
<a href=\"index.php?id=registers&amp;server=server1\"><b>1 SERVERIS</b></a><br/>
Serveris, kuriame nera taikoma palengvinimu.<br/>
</div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
<a href=\"index.php?id=registers&amp;server=server2\"><img src=\"http://dbf.us.lt/imgs/server2.php\" alt=\"2 serveris\"/></a><br/>
</div><div class=\"meniu\" style=\"text-align: center;\">
<a href=\"index.php?id=registers&amp;server=server2\"><b>2 SERVERIS</b></a><br/>
<u>Bus atidarytas šiandien 16:00</u>
<br/>
Čia padusmai po 2 sėk. treniruotės 2x pigesnios, drakono rutulių radimas 2x didėsnis, sąskaitos pildymas brangus.<br/>
</div><div class=\"line\"></div>
<div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"index.php\">Į pradžią</a><br/>
</div><div class=\"foot\">$bottom</div></div>";}
...
if (file_exists("server2/zaideju pagrindinai statusai/$nick.txt")){$klaida = "Toks nikas jau uzregistruotas!"; }
...
$ip = $_SERVER['REMOTE_ADDR']; 
$a = @file("s2/files for txt/registracijos_ip.txt"); 
for ($i=0; $i<count($a); $i++){
$b = explode("|",$a[$i]); 
if ($b[0] == $ip){$klaida = "Registruotis galima tik 1 kartą.";}}
...
fclose($fopy);
			...
			$timegav = time() + 60*60*24;	
			$fopy = @fopen("s2/paslaugos/daugiau pinigu/$nicko", "w");
@fwrite($fopy, "2|$timegav|");
@fclose($fopy);
@chmod("s2/paslaugos/daugiau pinigu/$nicko", 0777);	
			
$fopy = @fopen("s2/paslaugos/daugiau exp/$nicko", "w");
@fwrite($fopy, "3|$timegav|");
@fclose($fopy);
@chmod("s2/paslaugos/daugiau exp/$nicko", 0777);				
			
$fopy = @fopen("s2/paslaugos/didesnis nukaunamuma/$nicko", "w");
@fwrite($fopy, "3|$timegav|");
@fclose($fopy);
@chmod("s2/paslaugos/didesnis nukaunamuma/$nicko", 0777);	

$fopy = @fopen("s2/padusimai/$nicko", "w");
@fwrite($fopy, "3|$timegav|");
@fclose($fopy);
@chmod("s2/padusimai/$nicko", 0777);	
}}
}
*/
}
