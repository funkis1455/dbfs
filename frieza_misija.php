...
<img src=\"imgs/zona2.png\" alt=\"*\"/>
</div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
<u>Jums reikia nukauti visus Friezo parankinius ir jį pati.</u><br/>
&#302;veik&#281; &#353;i&#261; misij&#261; J&#363;s gausite <b>1 000 000 - 4 900 000 &#36;</b> pinig&#371;, <b>300 - 600</b> jėgos, <b>1 000 - 3 000</b> gynybos, bei yra galimyb&#279; laim&#279;ti kredit&#261;!";
echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[0] == "-"){
echo"$ico <a href=\"frieza_misija.php?id=kautis&amp;ka=Appule\">Appule</a> (10 000 kg)<br/>";
} else { echo"$ico Appule (10 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[1] == "-"){
echo"$ico <a href=\"frieza_misija.php?id=kautis&amp;ka=Cui\">Cui</a> (50 000 kg)<br/>";
} else { echo"$ico Cui (50 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[2] == "-"){
echo"$ico <a href=\"frieza_misija.php?id=kautis&amp;ka=Dodoria\">Dodoria</a> (70 000 kg)<br/>";
} else { echo"$ico Dodoria (70 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[3] == "-"){
echo"$ico <a href=\"frieza_misija.php?id=kautis&amp;ka=Zarbon\">Zarbon</a> (100 000 kg)<br/>";
} else { echo"$ico Zarbon (100 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[4] == "-"){
echo"$ico <a href=\"frieza_misija.php?id=kautis&amp;ka=Frieza\">Frieza</a> (200 000 kg)<br/>";
} else { echo"$ico Frieza (200 000 kg)<br/>";
}
}
else
{
echo"<b>Frieze</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
Frieze misiją galėsite vykdyti po <b>$lik</b> min.";
}
echo"</div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center; border-bottom: 1px solid #000000;\">
<a href=\"kaio_shin.php?id=misijos\">Atgal</a><br/>
...
<a href=\"frieza_misija.php?id=\">Atgal</a><br/>
<a href=\"pagrindinis.php?id=kovu_misijos\">Į Pagrindinį</a>
</div><div class=\"foot\">$bottom</div></div>";
}
else
...
$gkro = rand(300,500);
$gkr2o = rand(1000,2500);
$gpin = rand(1000000,5000000);

echo"Įvykdėte Frieza misiją, už tai gaunate <b>$gkro</b> jėgos, <b>$gkr2o</b> gynybos, <b>$gpin</b> pinigų ir 1 kreditą!</div><div class=\"meniu\" style=\"text-align: left;\">"; 
