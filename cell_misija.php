...
<img src=\"imgs/zona3.png\" alt=\"*\"/>
</div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
<u>Cell nori įsiurbti kiborgus ir tapti visagaliu, sutrukdykite jam tapti visagaliu.</u><br/>
&#302;veik&#281; &#353;i&#261; misij&#261; J&#363;s gausite, <b>2 000 - 4 000</b> jėgos ir <b>7 000 - 11 000</b> gynybos!";
echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[0] == "-"){
echo"$ico <a href=\"cell_misija.php?id=kautis&amp;ka=Cyborg 16\">Cyborg 16</a> (100 000 kg)<br/>";
} else { echo"$ico Cyborg 16 (100 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[1] == "-"){
echo"$ico <a href=\"cell_misija.php?id=kautis&amp;ka=Cyborg 17\">Cyborg 17</a> (500 000 kg)<br/>";
} else { echo"$ico Cyborg 17 (500 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[2] == "-"){
echo"$ico <a href=\"cell_misija.php?id=kautis&amp;ka=Cyborg 18\">Cyborg 18</a> (700 000 kg)<br/>";
} else { echo"$ico Cyborg 18 (700 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[3] == "-"){
echo"$ico <a href=\"cell_misija.php?id=kautis&amp;ka=Vegeta\">Vegeta</a> (1 000 000 kg)<br/>";
} else { echo"$ico Vegeta (1 000 000 kg)<br/>";
}echo"</div><div class=\"meniu\" style=\"text-align: left;\">";
if ($m[4] == "-"){
echo"$ico <a href=\"cell_misija.php?id=kautis&amp;ka=Cell\">Cell</a> (2 000 000 kg)<br/>";
} else { echo"$ico Cell (2 000 000 kg)<br/>";
}
}
else
{
echo"<b>Cell</b></div><div class=\"line\"></div><div class=\"meniu\" style=\"text-align: center;\">
Cell misiją galėsite vykdyti po <b>$lik</b> min.";
}
...
<a href=\"cell_misija.php?id=\">Atgal</a><br/>
<a href=\"pagrindinis.php?id=kovu_misijos\">Į Pagrindinį</a>
</div><div class=\"foot\">$bottom</div></div>";
}
else
...
$gkro = rand(2000,4000);
$gkr2o = rand(6000,11000);


echo"Įvykdėte Cell misiją, už tai gaunate <b>$gkro</b> jėgos, <b>$gkr2o</b> gynybos ir <b>$gpin</b> pinigų!</div><div class=\"meniu\" style=\"text-align: left;\">"; 
